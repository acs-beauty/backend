...
const setTokens = (res, id) => {
  ...
  res.cookie('accessToken', accessToken, { maxAge: 15 * 60 * 1000, httpOnly: true, sameSite: 'none' })
  res.cookie('refreshToken', refreshToken, { maxAge: 60 * 24 * 3600 * 1000, httpOnly: true, sameSite: 'none' })
