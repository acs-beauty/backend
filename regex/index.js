...
module.exports.validateSlug = /^[a-z]+(-[a-z]+)*$/
...
module.exports.arraySearchProductString = new RegExp(`^${engUkrNum}(,${engUkrNum})*$`)

module.exports.camelCaseString = /^[a-z]+(?:[A-Z][a-z]*)*$/

const ukrLetters = '[а-щьюяА-ЩЬЮЯґҐіІїЇєЄ]+'
module.exports.ukraineWordsString = new RegExp(`^${ukrLetters}(?:'?${ukrLetters})?(?:\\s{1}${ukrLetters}(?:'?${ukrLetters})?)*$`)
